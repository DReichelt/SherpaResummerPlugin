...
namespace RESUM {
  ...
  class Y5_CambridgeAachen: public Observable_Base {
  public:

    Y5_CambridgeAachen(const Observable_Key &args): 
	...
	for (int i=0;i<n;++i)
      ...
      kt2_5 = KT2(p[imap[jj]],p[imap[ii]]);
      return kt2_5/Q2;
    }

  };// end of class Y5_CambridgeAachen
