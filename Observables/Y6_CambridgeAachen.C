...
namespace RESUM {
  ...
  class Y6_CambridgeAachen: public Observable_Base {
  public:

    Y6_CambridgeAachen(const Observable_Key &args): 
	...
	for (int i=0;i<n;++i)
      ...
      kt2_6 = KT2(p[imap[jj]],p[imap[ii]]);
      return kt2_6/Q2;
    }

  };// end of class Y6_CambridgeAachen
