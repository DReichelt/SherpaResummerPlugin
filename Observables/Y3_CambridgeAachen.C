...
namespace RESUM {
  ...
  class Y3_CambridgeAachen: public Observable_Base {
  public:

    Y3_CambridgeAachen(const Observable_Key &args): 
	...
	for (int i=0;i<n;++i)
      ...
      kt2_3 = KT2(p[imap[jj]],p[imap[ii]]);
      return kt2_3/Q2;
    }

  };// end of class Y3_CambridgeAachen
